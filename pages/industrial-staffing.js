...
export default function Home() {
    ...
    const registusergeneral = async event => {
        ...
        xhttp.open("Post", 'https://ajrkhan.xyz/yomamultinational/wp-json/contact-form-7/v1/contact-forms/1988/feedback');
        xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;");
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {
                if (xhttp.status == 200) {
    ...
    return (
        <>
            <Head>
                <title>New Industrial Staffing Services For High Quality Manpower - YOMA</title>
                        ...
                        <div className="col-lg-6">
                            <div className="about-content wow fadeInRight delay-0-2s animated animateright">
                                <div className="section-title">
                                    ...
                                    <h2 className="mainh1"><span>Utilise</span> the best Industrial staffing services with YOMA!</h2>

                                </div>
                                <p className="text-justify">
                                    In the fast-paced world of industry, finding the right workforce is crucial for success.
                                    That's where YOMA's industrial staffing services shine. Our commitment to excellence sets us apart as leaders in providing the best industrial staffing solutions.
                                </p>

                                <p className="text-justify">
                                    By customising our services to meet the unique demands of your sector, YOMA ensures that you get more than just employees; you get strategic partners in your business growth.
                                </p>

                                <p className="text-justify">
                                    From skilled trades to managerial roles, our approach to industrial staffing guarantees a workforce that aligns seamlessly with your objectives
                                </p>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input type="number" id="number" name="number" className="form-control" maxlength="10" minlength="10" pattern="[0-9]*" placeholder="Contact Number*" required />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="wow fadeInLeft delay-0-2s animated animateleft">
                                ...
                                <img src="/assets/img/professional-staffing.jpg" alt="hr outsourcing company" />
                            ...
                            <div className="about-content wow fadeInRight delay-0-2s animated animateright">
                                ...
                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        Industrial staffing services are essential for businesses in industries like manufacturing, construction, and engineering. These services, offered by companies specializing in industrial staffing, help businesses find the right people for their jobs. Here's why industrial staffing is crucial:
                                    </p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        1. <b>Flexible Workforce:</b> Industrial staffing services allow businesses to adjust their workforce based on their needs. This flexibility is handy for handling changes in production demands or seasonal variations.
                                    </p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        2. <b>Tailored Solutions: </b>Industrial staffing companies provide customized solutions. They understand the specific skills and qualifications needed for different roles in the industrial sector.                                    </p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        3. <b>Efficiency Boost: </b>By partnering with an industrial staffing company, businesses can improve their efficiency and productivity. These services streamline the hiring process and ensure that workers meet industry standards and safety requirements.  </p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        4. <b>Diverse Industries: </b>Industrial staffing caters to various industries, ensuring that businesses get the right personnel with the appropriate skills for their specific field.</p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        5. <b>Training Programs: </b>Many industrial staffing services offer training programs to enhance the skills of their workers. This helps create a workforce that is not only skilled but also adaptable to different tasks.</p>
                                </div>

                                <div class="ellipsis-container">
                                    <p class="text-justify elllipse-text mb-1">
                                        In summary, industrial staffing services act as valuable partners for businesses, helping them navigate workforce challenges and ensuring they have the right people for the job.</p>
                                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="about-content wow fadeInRight delay-0-2s animated animateright">
                                <div className="section-title">
                                    {/* <h2 className="mainh1"><span>We Help</span> You Run Your Business Efficiently</h2> */}
                                    <h2 className="mainh1"><span>Why Industrial Staffing</span> is Important for Industries?
                                    </h2>
                                ...
                                <p class="text-justify mb-1">
                                    Industrial staffing services have become increasingly important for businesses.
                                    Industrial staffing bridges the gap between demand and supply in the labour market, ensuring that organisations have access to a skilled and flexible workforce precisely when they need it.                                </p>
                                <ul className='p-8'>
                                    <li className='list text-justify'>One key advantage of engaging an industrial staffing company lies in its ability to provide timely and cost-effective solutions. </li>
                                    <li className='list text-justify'>Industries often experience fluctuations in demand, and having access to a temporary workforce through industrial staffing services allows companies to scale their workforce up or down as needed. </li>
                                    <li className='list text-justify'>Industrial staffing excels in managing production peaks, accommodating seasonal demand, and responding to unforeseen challenges, ensuring that operational continuity is maintained.</li>
                                    <li className='list text-justify elllipse-text1'>Outsourcing staffing concerns to a specialized agency enables businesses to streamline their human resource processes, reduce administrative burdens, and concentrate on enhancing their operational efficiency. YOMA,, uses its industry knowledge and network to identify top talent, ensuring that client organisations can maintain high standards of productivity and quality. These services provide a strategic approach to workforce management, offering the flexibility and expertise needed to navigate difficulties in the industrial landscape.</li>
                                    <li className='list text-justify elllipse-text1'>  By partnering with an industrial staffing company, organizations can optimize their workforce, respond to market dynamics, and ultimately achieve sustainable success in a competitive environment.</li>
                                    <li className='list text-justify elllipse-text1'>  Industrial staffing solutions cover a broad spectrum of roles, including production workers, machine operators, logistics coordinators, and maintenance technicians.</li>
                                    <li className='list text-justify elllipse-text1'> Similarly,YOMA ensures the availability of temporary staff , as well as permanent staff industries that can meet demand without compromising quality.</li>
            ...
            <section className="cournter-section-three bg-lighter text-center pt-65 rpt-95 pb-70 rpb-50">
                <div className="container">
                    <div className="section-title mb-55">
                        <h3 className='h3cc mainh1'><span>Why We Stand Out as</span>  Best Industrial Staffing Partners</h3>
                        <p>
            ...
            <section className="featured-section bgs-cover pt-40 homeservicebg">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 col-md-8 col-sm-10">
                            <div className="section-title text-center mb-35">
                                <h2 className="mainh1"><span>Types</span> of Staff We Provide </h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="feature-item wow fadeInUp delay-0-2s new-shadow">
                                ...
                                <div className="feature-content">
                                    ...
                                    <p>Amid the rising complexities, we serve organisations in fulfilling their contractual or temporary staffing by offering third-party staffing services. We specialise in general staffing, seasonal, long-term, and project-based manpower requirements.</p>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="feature-item wow fadeInUp delay-0-4s new-shadow">
                                ...
                                <div className="feature-content">
                                    ...
                                    <p>Whether you require technical expertise, a specialized workforce, or unskilled labor, our comprehensive staffing solutions have you covered. Additionally, our expertise extends to industrial staffing, ensuring that your specific....</p>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="feature-item wow fadeInUp delay-0-6s new-shadow">
                                ...
                                <div className="feature-content">
                                    ...
                                    <p>Staff augmentation is a flexible outsourcing strategy that helps you hire talent across profiles and verticals. You can personally choose the candidates as per your budget and keep your hiring costs of one of the best staffing....</p>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="feature-item wow fadeInUp delay-1-0s new-shadow">
                                ...
                                <div className="feature-content">
                                    ...
                                    <p>As a nation with a demographic advantage, boasting 62% of population, YOMA firmly believe in not just employing, but in actively....</p>
                        ...
                        <div className="col-xl-4 col-md-6">
                            <div className="feature-item wow fadeInUp delay-1-2s new-shadow">
                                ...
                                <div className="feature-content">
                                    ...
                                    <p>Unlike unpaid internships, apprenticeships offer valuable work experience with the added benefit of earning a salary, making them....</p>
            ...
            <section className="">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 col-md-8 col-sm-10">
                            <div className="section-title text-center mb-35">
                                <h2 className="mainh1"><span>Industries</span>  we Serve?</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="new-slick">
                        <div className="row mb-3">
                            ...
                            <div class="box-button col-md-3">Logistics and Transportation </div>
                        </div>
                        <div className="row mb-3">
                        ...
                        <div className="row mb-3">
                            ...
                            <div class="box-button col-md-3">Chemical and Pharmaceutical  </div>
                        </div>
            ...
            <section className="Generalfaq">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 col-md-8 col-sm-10">
                            <div className="section-title text-center mb-35">
                                <h2 className="mainh1"><span>General </span> Faqs</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card border-0 mb-2 card-bg">
                            <div class="card-header" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <i class="fas fa-plus float-right"></i>
                                        1. What industries does YOMA specialize in for industrial staffing?
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body cardbody-bg">
                                    YOMA covers manufacturing, logistics, energy, construction, and more.
                                </div>
                            </div>
                        </div>
                        <div class="card border-0 mb-2  card-bg">
                            <div class="card-header" id="headingTwo">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="fas fa-plus float-right"></i>
                        ...
                        <div class="card border-0 mb-2 card-bg">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <i class="fas fa-plus float-right"></i>
                        ...
                        <div class="card border-0 mb-2 card-bg">
                            <div class="card-header" id="headingFour">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                                        <i class="fas fa-plus float-right"></i>
                        ...
                        <div class="card border-0 mb-2 card-bg">
                            <div class="card-header" id="headingFive">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        <i class="fas fa-plus float-right"></i>
                        ...
                        <div class="card border-0 mb-2 card-bg d-none">
                            <div class="card-header" id="headingSix">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        <i class="fas fa-plus float-right"></i>
                            ...
                            <div id="collapseSix" class="collapse" aria-labelledby="collapseSix" data-parent="#accordionExample">
                                <div class="card-body cardbody-bg">
                                    Roles like production workers, machine operators, quality control, logistics, and maintenance.                                </div>
                            </div>
                        </div>
                        <div class="card border-0 mb-2 card-bg d-none">
                            <div class="card-header" id="headingSeven">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                        <i class="fas fa-plus float-right"></i>
                            ...
                            <div id="collapseSeven" class="collapse" aria-labelledby="collapseSeven" data-parent="#accordionExample">
                                <div class="card-body cardbody-bg">
                                    We stay updated on trends and technology through continuous team training.                                </div>
                            </div>
                        </div>
                        <div class="card border-0 mb-2 card-bg d-none">
                            <div class="card-header" id="headingEight">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0 collapsed" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                        <i class="fas fa-plus float-right"></i>
                                        8. Does YOMA offer permanent placements?
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseEight" class="collapse" aria-labelledby="collapseEight" data-parent="#accordionExample">
                                <div class="card-body cardbody-bg">
                        ...
                        <div class="card border-0 mb-2 card-bg d-none">
                            <div class="card-header" id="headingNine">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
                                        <i class="fas fa-plus float-right"></i>
                        ...
                        <div class="card border-0 mb-2 card-bg d-none">
                            <div class="card-header" id="headingTen">
                                <h2 class="mb-0">
                                    <button class="btn btn-link text-decoration-none btn-block text-left text-light p-0" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                                        <i class="fas fa-plus float-right"></i>
                            ...
                            <div id="collapseTen" class="collapse" aria-labelledby="collapseTen" data-parent="#accordionExample">
                                <div class="card-body cardbody-bg">
                                    Yes, we offer HR services like benefits administration and consulting.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <button type="button" class="btn btn-outline-primary mt-4 mb-4" id="showMoreBtn">Read More</button>
                    </div>
