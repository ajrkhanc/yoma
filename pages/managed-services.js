...
export default function ManagedServices() {
    ...
    return (
        <>
            ...
            <Head>
                <title>Managed Service Provider in India | Employee MSP Consultant & Hiring Solutions
                </title>
                <meta name="description" content="Managed services providers (MSPs) provide outsourced IT services. The MSP model allows a framework for remotely managing a customer's IT infrastructure." />
                <meta property="og:url" content="https://yomabusinesssolutions.com/managed-services" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Best Managed Service Provider for Employee Management - YOMA" />
                <meta property="og:description" content="YOMA is the best managed services provider for employee management that provides regular support and active resources to its clients and partners." />
                ...
                <meta name="twitter:title" content="Best Managed Service Provider for Employee Management - YOMA/" />
                <meta name="twitter:description" content="YOMA is the best managed services provider for employee management that provides regular support and active resources to its clients and partners." />
                ...
                <meta itemprop="Best Managed Service Provider for Employee Management - YOMA" />
                ...
                <script type="application/ld+json"
                        ...
                        __html: `
                  {
                    ...
                    "potentialAction": {
                      "@type": "SearchAction",
                      "target": "https://yomabusinesssolutions.com/managed-services{search_term_string}",
